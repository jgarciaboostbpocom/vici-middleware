...
check(/failureHandlingFallbackReadiness,\s*humanHandoffSlaReadiness,\s*(providerAbstractionReadiness,\s*(observabilityMonitoringReadiness,\s*(qaTranscriptRecordingIntakeReadiness,\s*)?)?)?checklist/s.test(readiness), 'readiness response payload includes humanHandoffSlaReadiness after failureHandlingFallbackReadiness');
