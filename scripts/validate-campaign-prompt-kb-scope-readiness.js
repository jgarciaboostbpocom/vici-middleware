...
check(/campaignAiQaScopeReadiness,\s*campaignPromptKbScopeReadiness,\s*(campaignQaProvisioningReadiness,\s*(qaRbacAccessScopeReadiness,\s*(qaEvaluationWorkflowReadiness,\s*(qaReportsAnalyticsReadiness,\s*)?)?)?)?checklist/s.test(readiness), 'readiness response payload must include campaignPromptKbScopeReadiness after campaignAiQaScopeReadiness');
